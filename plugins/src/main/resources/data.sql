...
insert into einheit (id, name)
values ('b9db54bc-8c54-4163-bc25-1ed10b75edea', 'Stück');
insert into einheit (id, name)
values ('50ac5ca8-0a29-45fe-88cc-d2070fb90303', 'Liter');
insert into kategorie (id, name, icon)
values ('6abeec3f-fdc4-49b1-b64e-e005b45051cb', 'Gemüse',
...
values ( '35186fbe-6f46-4824-8d91-c80b7ad50f5d'
       ...
       , 9);
insert into produkt (id, name, kategorie_id, einheit_id, ist_lagerbestand, soll_lagerbestand)
values ( '1607bb47-139e-466c-80e0-a1bcad7c9996'
       , 'Roggenbrot'
       , '87c9cc6b-735d-4f48-badb-1d3fe39871dd'
       , 'b9db54bc-8c54-4163-bc25-1ed10b75edea'
       , 2.5
